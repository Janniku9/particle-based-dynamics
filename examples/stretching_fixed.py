...
c1 = GridCloth(N=(32, 32), S=(0.5, 0.5), KS=1, KB=0.4, KC=1, center=ti.Vector([0.5, 0, 0.01]), KL=0, KD=0)
c1.fix_point(0)
c1.fix_point(31 * 32)
...
c2 = GridCloth(N=(32, 32), S=(0.5, 0.5), KS=0.6, KB=0.4, KC=1, center=ti.Vector([-0.5, 0, 0.01]), KL=0, KD=0)
c2.fix_point(0)
c2.fix_point(31 * 32)
...
sim.make_video("stretching_fixed")
sim.run()