...
sim.set_camera((-1.6 * ti.cos(1), 1.6 * ti.sin(1), 0.5), (0, 0, 0))
sim.add_light((-0.1, -0.1, 1), (1, 1, 1))
sim.set_wind(ti.Vector([-150, -200, 50]))

c = GridCloth(N=(32, 32), S=(0.5, 0.5), KS=1, KB=0.1, KC=1, center=ti.Vector([0, 0, 0.01]), KL=0.2, KD=1)
c.fix_point(0)
c.fix_point(31 * 32)
c.fix_point(31 * 32 + 31)
c.fix_point(31)
sim.add_cloth(c)
